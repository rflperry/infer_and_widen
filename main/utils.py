...
def plot_and_save_results(
    ...
    plt.clf()
    plt.plot(
        xaxis, local_median, "lightcoral", label="locally simultaneous", linewidth=3
    )
    if fill_between:
    ...
    if plot_simultaneous:
        plt.plot(
            xaxis, simultaneous_median, "dodgerblue", label="simultaneous", linewidth=3
        )
        if fill_between:
            plt.fill_between(
                xaxis, simultaneous_5, simultaneous_95, color="dodgerblue", alpha=0.2
            )
    ...
    if plot_hybrid:
        ...
        if fill_between:
            plt.fill_between(
                xaxis, hybrid_5, hybrid_95, color="mediumturquoise", alpha=0.2
            )
    ...
    if plot_baseline:
        if baseline_val != None:
            ...
            plt.plot(
                xaxis,
                [2 * scipy.stats.norm.isf(alpha / 2)] * len(xaxis),
                "gray",
                linewidth=3,
                linestyle="dashed",
            )
...
def make_interval(
    ci_lsi, ci_fsi, ci_cond, ci_hybrid, plot_title, to_celsius=True, legend=True
):
    if to_celsius:
        offset = 273
    else:
    ...
    plt.plot(
        [ci_lsi[0] - offset, ci_lsi[1] - offset],
        [0.7, 0.7],
        linewidth=20,
        color="lightsalmon",
        path_effects=[
            pe.Stroke(linewidth=22, offset=(-1, 0), foreground="lightcoral"),
            pe.Stroke(linewidth=22, offset=(1, 0), foreground="lightcoral"),
            pe.Normal(),
        ],
        label="locally simultaneous",
        solid_capstyle="butt",
    )
    plt.plot(
        [ci_fsi[0] - offset, ci_fsi[1] - offset],
        [0.55, 0.55],
        linewidth=20,
        color="lightskyblue",
        path_effects=[
            pe.Stroke(linewidth=22, offset=(-1, 0), foreground="dodgerblue"),
            pe.Stroke(linewidth=22, offset=(1, 0), foreground="dodgerblue"),
            pe.Normal(),
        ],
        label="simultaneous",
    ...
    plt.plot(
        [ci_cond_temp[0] - offset, ci_cond_temp[1] - offset],
        [0.4, 0.4],
        linewidth=20,
        color="wheat",
        path_effects=[
            pe.Stroke(linewidth=22, offset=(-noclip_l, 0), foreground="goldenrod"),
            pe.Stroke(linewidth=22, offset=(noclip_u, 0), foreground="goldenrod"),
            pe.Normal(),
        ],
        label="conditional",
        solid_capstyle="butt",
    ...
    plt.plot(
        [ci_hybrid[0] - offset, ci_hybrid[1] - offset],
        [0.25, 0.25],
        linewidth=20,
        color="paleturquoise",
        path_effects=[
            pe.Stroke(linewidth=22, offset=(-1, 0), foreground="mediumturquoise"),
            pe.Stroke(linewidth=22, offset=(1, 0), foreground="mediumturquoise"),
            pe.Normal(),
        ],
        label="hybrid",
...
def make_multiple_intervals(
    ...
    for i in reversed(range(k)):
        ...
        if i == 0:
            plt.plot(
                [ci_lsi[0][i] - offset, ci_lsi[1][i] - offset],
                [0.7 + i * 0.02, 0.7 + i * 0.02],
                linewidth=20,
                color="lightsalmon",
                path_effects=[
                    pe.Stroke(linewidth=22, offset=(-1, 0), foreground="lightcoral"),
            ...
            plt.plot(
                [ci_fsi[0][i] - offset, ci_fsi[1][i] - offset],
                [0.55 + i * 0.02, 0.55 + i * 0.02],
                linewidth=20,
                color="lightskyblue",
                path_effects=[
                    pe.Stroke(linewidth=22, offset=(-1, 0), foreground="dodgerblue"),
            ...
            plt.plot(
                [ci_cond_temp[0] - offset, ci_cond_temp[1] - offset],
                [0.4 + i * 0.02, 0.4 + i * 0.02],
                linewidth=20,
                color="wheat",
                path_effects=[
                    pe.Stroke(
                        linewidth=22, offset=(-noclip_l, 0), foreground="goldenrod"
                    ),
                    pe.Stroke(
                        linewidth=22, offset=(noclip_u, 0), foreground="goldenrod"
                    ),
                    pe.Normal(),
                ],
                label="conditional",
            ...
            plt.plot(
                [ci_hybrid[0][i] - offset, ci_hybrid[1][i] - offset],
                [0.25 + i * 0.02, 0.25 + i * 0.02],
                linewidth=20,
                color="paleturquoise",
                path_effects=[
                    pe.Stroke(
                        linewidth=22, offset=(-1, 0), foreground="mediumturquoise"
                    ),
                    pe.Stroke(
                        linewidth=22, offset=(1, 0), foreground="mediumturquoise"
                    ),
        ...
        if i > 0:
            plt.plot(
                ...
                [0.7 + i * 0.02, 0.7 + i * 0.02],
                linewidth=20,
                color=lighten_color("lightsalmon", 0.8 / i),
                path_effects=[
                    pe.Stroke(linewidth=22, offset=(-1, 0), foreground="lightcoral"),
                    pe.Stroke(linewidth=22, offset=(1, 0), foreground="lightcoral"),
                    pe.Normal(),
            ...
            plt.plot(
                ...
                [0.55 + i * 0.02, 0.55 + i * 0.02],
                linewidth=20,
                color=lighten_color("lightskyblue", 0.8 / i),
                path_effects=[
                    pe.Stroke(linewidth=22, offset=(-1, 0), foreground="dodgerblue"),
                    pe.Stroke(linewidth=22, offset=(1, 0), foreground="dodgerblue"),
                    pe.Normal(),
            ...
            plt.plot(
                ...
                [0.4 + i * 0.02, 0.4 + i * 0.02],
                linewidth=20,
                color=lighten_color("wheat", 0.8 / i),
                path_effects=[
                    pe.Stroke(
                        linewidth=22, offset=(-noclip_l, 0), foreground="goldenrod"
                    ),
            ...
            plt.plot(
                ...
                [0.25 + i * 0.02, 0.25 + i * 0.02],
                linewidth=20,
                color=lighten_color("paleturquoise", 0.8 / i),
                path_effects=[
                    pe.Stroke(
                        linewidth=22, offset=(-1, 0), foreground="mediumturquoise"
                    ),
